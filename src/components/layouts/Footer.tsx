const footerNavigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://facebook.com/devhaiti',
      icon: (props) => (
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/devhaiti',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/devhaiti',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export const Footer = () => (
  <footer className="mt-24 bg-gray-900 sm:mt-12">
    <div className="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <p className="mt-8 text-center text-base text-gray-400">&copy; dono. All rights reserved.</p>
    </div>
  </footer>
);
